...
export const ThemeProvider = ({ children }) => {
  const [theme, setThemeState] = useState(() => {
    ...
    const validThemes = ['dark', 'minimal', 'claymorphism', 'refero', 'slash', 'steep', 'ventriloc', 'tiffany-dark', 'tiffany-light', 'true-pink', 'chill-white', 'cyprus-green', 'sand-pine', 'mantis-green', 'milky-mantis', 'bridal-burgundy', 'skin-tone'];
  ...
  useEffect(() => {
    ...
    const themeClasses = [
      ...
      'theme-refero', 'theme-slash', 'theme-steep', 'theme-ventriloc', 'theme-tiffany-dark', 'theme-tiffany-light', 'theme-true-pink', 'theme-chill-white', 'theme-cyprus-green', 'theme-sand-pine', 'theme-mantis-green', 'theme-milky-mantis', 'theme-bridal-burgundy', 'theme-skin-tone'
    ];
  ...
  const toggleTheme = () => {
    const cycle = ['dark', 'minimal', 'claymorphism', 'refero', 'slash', 'steep', 'ventriloc', 'tiffany-dark', 'tiffany-light', 'true-pink', 'chill-white', 'cyprus-green', 'sand-pine', 'mantis-green', 'milky-mantis', 'bridal-burgundy', 'skin-tone'];
