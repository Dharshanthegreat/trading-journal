...
export const ThemeProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const themeClasses = [
      ...
      'theme-refero', 'theme-slash', 'theme-steep', 'theme-ventriloc', 'theme-tiffany-dark', 'theme-tiffany-light', 'theme-true-pink', 'theme-chill-white', 'theme-cyprus-green', 'theme-sand-pine', 'theme-mantis-green', 'theme-milky-mantis', 'theme-bridal-burgundy', 'theme-skin-tone', 'theme-emerald-dark'
    ];
